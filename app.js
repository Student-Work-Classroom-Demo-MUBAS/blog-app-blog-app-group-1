...
const blogData = {
  "lake-malawi": {
    title: "Lake Malawi",
    image: "https://images.unsplash.com/photo-1570884624556-db8ae6625322?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
    content: `
...
// API endpoint to get blog content
...
// Start server
app.listen(port, () => {
  console.log(`Malawi blog app listening at http://localhost:${port}`);
});