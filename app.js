...
let posts = [
  {
    ...
    content: `
      ...
      species of cichlids, with many still waiting to be discovered and described.
  ...
  },
  {
    ...
    content: `
      ...
      and higher rainfall than the surrounding areas.Mulanje is ecologically significant as it 
      hosts numerous endemic species of plants and animals, including the Mulanje cedar 
      (Widdringtonia whytei), Malawi's national tree. This slow-growing conifer is critically 
      endangered due to illegal logging and fires. The mountain holds cultural significance for the
      ...
      by the Malawi Mountain Club providing accommodation for multiday treks. The challenging ascent to Sapitwa Peak offers breathtaking views of the surrounding landscape.</p>
    `,
  ...
  { 
    ...
    content: `
      ...
      temperatures sometimes dropping below freezing in winter. This unique environment supports 
      flora and fauna not found elsewhere in Malawi, including orchids, proteas, and over 400 species
      of birds. Large mammals found on the plateau include eland, roan antelope, zebra, leopard, 
      and elephant. The park is particularly known for its high density of leopards, though these
  ...
  },
  {
    ...
    content: `
      ...
      where visitors can see all of Africa's "Big Five" (except rhino).The Shire River, which 
      flows along the western boundary of the park, is its lifeblood. Boat safaris along the 
      river offer excellent opportunities to view wildlife, particularly hippos and crocodiles. 
      The river is also home to rare and endangered species such as the African skimmer and Nile 
      monitor lizard. Local communities have lived around the park for generations, and 
  ...
  },
  {
    ...
    content: `
      ...
      lands and provide drinking water for the city below.
